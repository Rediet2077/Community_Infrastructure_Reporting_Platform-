    ...
    switch (index) {
      ...
      case 1:
        return active.where((r) {
          ...
          return s == 'in_progress' || s == 'under_review' || s == 'accepted' ||
              s == 'assigned' || s == 'submitted' || s == 'pending_verification' ||
              s == 'in progress' || s == 'under review';
        }).toList();
      case 2:
        return active
      ...
      case 3:
        return active
            .where((r) => (r['status'] as String? ?? '').toLowerCase() == 'rejected')
            .toList();
      default:
        return active;
    }
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.image_outlined, color: accentColor.withValues(alpha: 0.5), size: 30),
                  ),
                  Expanded(
                    child: Padding(
