...
class _ReportProblemScreenState extends State<ReportProblemScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Could not pick image: $e'), backgroundColor: AppColors.red),
        );
      }
    }
  }
  ...
  List<String> get _currentSubcategories => _subcategories[_selectedCategory] ?? ['Other'];
            ...
            child: Stack(children: [
              FlutterMap(
                ...
                children: [
                  ...
                  MarkerLayer(markers: [
                    Marker(point: _pickedLatLng, width: 40, height: 48, child: const _PinWidget()),
                  ]),
                ],
              ),
