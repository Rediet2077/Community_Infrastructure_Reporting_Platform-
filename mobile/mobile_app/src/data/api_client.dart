...
class ApiClient {
  ...
  Future<List<String>> categories() async =>
      (jsonDecode(await _get('/products/categories')) as List).cast<String>();

  Future<UserProfile> user(int id) async =>
      UserProfile.fromJson(jsonDecode(await _get('/users/$id')));
  ...
  Future<String> _get(String path) async {
    try {
      ...
      throw ApiException('Check your connection and try again.');
    }
  }
}
