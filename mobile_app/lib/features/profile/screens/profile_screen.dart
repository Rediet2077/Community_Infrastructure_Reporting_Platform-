      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _showSettings(context, l10n),
          ),
        ],
      ),
        ...
        Stack(children: [
          ...
          Positioned(
              ...
              child: GestureDetector(
                onTap: () => _showEditProfile(context, l10n),
                child: Container(
                  width: 26,
                  height: 26,
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        _MenuItem(
            ...
            label: l10n.language,
            trailing: langProvider.currentLanguageName(),
        ...
        _MenuItem(
            ...
            showChevron: false,
            onTap: () => _showLogout(context, l10n)),
      ]),
    );
  }
          ...
          child: Column(
              ...
              children: [
                ...
                const _FaqTile(
                    ...
                    answer:
                        'Tap the + button on the bottom navigation bar, or go to Home and tap "Report Problem". Follow the 4-step process.'),
                const _FaqTile(
                ...
                children: [
                  ...
                  Text(l10n.selectLanguage,
                      style: const TextStyle(
                          ...
                          color: AppColors.textPrimary)),
                  const SizedBox(height: 16),
                  ...lp.languageOptions.map((lang) {
                    final isSelected = lp.languageCode == lang['code'];
